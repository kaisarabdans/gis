...
<html lang="id">
  <head>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD-SWjRXCtCmFHMSQCaiZIN34zwBt4JKCQ&language=id&region=ID"></script>
    <script>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?m=transportasi"><span class="glyphicon glyphicon-plane"></span> Transportasi</a></li>  
            <li><a href="?m=kosan"><span class="glyphicon glyphicon-home"></span> Kosan</a></li>
            <li><a href="?m=stationary"><span class="glyphicon glyphicon-floppy-disk"></span> Stationary</a></li>
            <li><a href="?m=lokasikreasi"><span class="glyphicon glyphicon-scissors"></span> Lokasi Kreasi</a></li>
